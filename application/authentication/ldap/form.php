...
<form method='post'
    ...
    <div class="form-group concrete-login">
        <span><?php echo t('Sign in with your '.$this->getAuthenticationTypeName().' account.') ?> </span>
        <hr>
    </div>
    ...
    <div class="form-group">
        ...
        <!-- TODO: CHANGE THIS TO YOUR PASSWORD URL -->
        <!-- <a href="PASSWORDCHANGEURL" class="btn pull-right" target="_blank"><?php echo t('Forgot Password') ?></a> -->
    </div>
